...
\newpage
    ...
    enfoque conceptual y algorítmico, el proyecto sienta las bases técnicas para transitar desde la reparación reactiva hacia una estrategia de mantenimiento preventivo y eficiente.

    \subsection{Definición del problema}
    \noindent
    El mantenimiento de las redes FTTH en el escenario actual se ejecuta bajo una estrategia predominante reactiva. Ante la ocurrencia de eventos disruptivos o fallas físicas en la infraestructura,
    ...
    \begin{itemize}
        ...
        predictivos para gestionar personal quien encargado del mantenimiento preventivo. Como usuarios secundarios o beneficiarios indirectos se encuentran los clientes finales, quienes experimentarán una mejora sustancial en la QoE
...
resolviendo así la problemática del mantenimiento reactivo en un operador a gran escala con una solución técnica lista para su evaluación en terreno. 
    ...
    \section{Requisitos del Sistema:}  
        ...
        \subsection{\textbf{Requerimientos de Interfaces:}}
                    \begin{itemize}
                        ...
                        \item Interfaz de Salida (Resultados): El sistema deberá exportar las predicciones generadas a un formato estandarizado (por ejemplo, un archivo \textbf{.csv} con el identificador del equipo y su probabilidad de falla) para que pueda ser interpretado por la gerencia.
    ...
    \noindent
    Desarrollar y validar un pipeline y modelo predictivo basado en algoritmos de aprendizaje automático capaz de anticipar degradaciones físicas en la infraestructura FTTH de Liberty Latinamerica, proporcionando estimaciones probabilísticas
...
\newpage
  \section{Arquitectura Revisada del Sistema:}
    ...
    \noindent
    La figura \ref{MODELO ML} resume la arquitectura de alto nivel del modelo predictivo destinado para la posible detección de degradaciones en la red FTTH. La descripción de cada bloque lo puede encontrar en la sección 4.2.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                F1-Score y el Área bajo la curva de precisión sensibilidad ($PR_AUC$) durante la validación cruzada.
            \end{itemize}
